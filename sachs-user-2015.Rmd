...
<text x=350 y=40 class = "text1" id="second" fill = "red", font-size = "33px">
ggplot2+gridSVG
</text>
...
```{r ggtosvg, fig.keep='none', results = 'asis', fig.width=7.5, fig.height=4}
ggplot(mtcars, aes(mpg, hp)) + geom_point(size = 3)
grid::grid.force()
...
- Use DOM power of `d3.js` to provide interactivity
...
- @sachsmc ([github](http://github.com/sachsmc), [twitter](http://twitter.com/sachsmc))
