var pline = d3.select("[id='km2GRID.polyline.381.1.1']");
var panel = d3.select("[id='km2panel.background.rect.387.1.1']");
var newy1 = d3.select("[id='km2GRID.polyline.381.1']").attr("tipy1").split(",");
var newx1 = d3.select("[id='km2GRID.polyline.381.1']").attr("tipx1").split(",");
var newy2 = d3.select("[id='km2GRID.polyline.381.1']").attr("tipy2").split(",");
var newx2 = d3.select("[id='km2GRID.polyline.381.1']").attr("tipx2").split(",");
